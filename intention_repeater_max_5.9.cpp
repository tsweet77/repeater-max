/*
    Intention Repeater MAX v5.9 (c)2020-2022 by Anthro Teacher aka Thomas Sweet.
...
void print_help()
{
    ...
    cout << LIGHTBLUE
         << "Intention Repeater MAX v5.9 (c)2020-2022 by Anthro Teacher aka "
            "Thomas Sweet."
         << endl;
...
int main(int argc, char **argv)
{
    ...
    cout << "Intention Repeater MAX v5.9 (c)2020-2022 by Anthro Teacher aka "
            "Thomas Sweet."
         << endl;
    cout << "Performance benchmark, exponents and flags by Karteek Sheri." << endl;

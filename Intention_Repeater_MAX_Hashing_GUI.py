...
IRM = "Intention_Repeater_MAX_Hashing.exe"
...
class IntentionRepeaterGUI:
    ...
    def __init__(self, master):
        self.master = master
        master.title("Intention Repeater MAX Hashing GUI")
        ...
        self.hashing_checkbox = ttk.Checkbutton(master, text="Use Initial Hashing", variable=self.hashing_var)
        self.hashing_checkbox.grid(row=10, column=2, padx=5, pady=5, sticky="w")
        ToolTip(self.hashing_checkbox, text = "Use Initial Hashing at Beginning to multiply the repetition rate. This program hashes while running anyway.")
    ...
    def on_run_clicked(self):
        ...
        # Your existing code to launch IRM = "Intention_Repeater_MAX_Hashing.exe" goes here

/*
    ...
    Intention Repeater MAX is powered by a Servitor (20 Years / 2000+ hours in the making).
...
{
    std::string process_intention, intention, intention_value, duration, param_duration, intention_hashed;
    ...
    std::string param_compress, param_hashing, useHashing, useCompression, param_file2;

/*
    Intention Repeater MAX v3.7 (c)2020-2021 by Thomas Sweet aka Anthro Teacher
    Performance benchmark, enhancement and flags by Karteek Sheri.
    Updated 5/11/2021 by Thomas Sweet aka Anthro Teacher.
...
void print_help() {
    ...
    cout << "Intention Repeater MAX v3.7 (c)2020-2021 by Thomas Sweet aka Anthro Teacher." << endl;
    ...
    cout << "--timer = Specify INEXACT or EXACT. INEXACT Variance ~ 8ms/sec. EXACT variance ~ 0.05ms/sec. INEXACT ~ 6X Faster. Default = INEXACT." << endl;

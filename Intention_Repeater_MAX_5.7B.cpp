/*
    Intention Repeater MAX v5.7B (c)2020-2024 by Anthro Teacher aka Thomas Sweet.
    This version has --file flag.
    Compile: g++ -O3 -Wall -static Intention_Repeater_MAX_5.7B.cpp -o Intention_Repeater_MAX_5.7B.exe
    ...
    Updated 4/16/2024 by Anthro Teacher.
...
void print_help()
{
    ...
    cout << LIGHTBLUE
         << "Intention Repeater MAX v5.7B (c)2020-2024 by Anthro Teacher aka "
            "Thomas Sweet."
         << endl;
    ...
    cout << " p) --file or -l" << endl;
    cout << " q) --help or -h" << endl
         << endl;
    ...
    cout << "--file = File to import. Will override Intention." << endl;
...
{
    std::string intention, PROCESS_STATEMENT, process_intention, intention_value, duration, param_duration, param_file,
        param_intention, param_intention_2, param_timer, param_boostlevel, param_freq, param_color, param_usehololink, intention_display = "",
    ...
    cout << "Intention Repeater MAX v5.7B (c)2020-2024 by Anthro Teacher aka "
            "Thomas Sweet."
         << endl;
    cout << "Performance benchmark, exponents and flags by Karteek Sheri." << endl;
                ...
                if ((restevery_int > 0) && (seconds % restevery_int == 0))
                {
                    ...
                    if (suffix_value == "EXP")
                    {
                        std::cout << "[" + runtime_formatted + "]"
                                  << " (" << setprecision(3) << fixed
                                  << (stoull(iterations_string.substr(0, 4))) / pow(10, 3) << "x10^" << digits - 1 << " / "
                                  << "0 Hz): " << intention_display << "      \r" << std::flush;
                    }
                    else // suffix_value = "HZ"
                    {
                        std::cout << "[" + runtime_formatted + "]"
        ...
        do
        {
            ...
            if (suffix_value == "EXP")
            {
                std::cout << "[" + runtime_formatted + "]"
                          ...
                          << "x10^" << freq_digits - 1 << " Hz): " << intention_display << "     \r" << std::flush;
            }
            else // suffix_value = "HZ"
            {
                std::cout << "[" + runtime_formatted + "]"

/*
    Intention Repeater MAX v3.4 created by Thomas Sweet.
    Performance benchmark, enhancement and flags by Karteek Sheri.
    Created 5/9/2021 for C++.
...
void print_help() {
  cout << "Intention Repeater MAX v3.4 (c)2020-2021 Thomas Sweet aka Anthro Teacher." << endl;
...
int main(int argc, char ** argv) {
  ...
  cout << "Intention Repeater MAX v3.4 created by Thomas Sweet." << endl;
  ...
  do {
    ...
    while ((chrono::duration_cast < chrono::nanoseconds > (end - start).count() < 1E9)) {
